...
public class Engine {
    ...
    public void run() {
        ...
        crossShader = new Shader(CROSS_VS, CROSS_FS);
        ...
        while (!Window.shouldClose()) {
            ...
            if (InputProcessor.isMouseButtonPressed(0) || InputProcessor.isMouseButtonPressed(1)) {
                HitResult result = raycastBlock(MAX_REACH);
                if (result != null) {
                    boolean placing = InputProcessor.isMouseButtonPressed(0);
